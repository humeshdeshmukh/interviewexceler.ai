...
import { SalaryFormWizard } from './components/SalaryFormWizard';
      ...
      <div className="max-w-6xl mx-auto relative">
        ...
        <AnimatePresence mode="wait">
          {!showResults ? (
            ...
            >
              <SalaryFormWizard onSubmit={handleSubmit} />
            </motion.div>
          ) : (
            <motion.div
              key="results"
            ...
            >
              <div className="flex justify-start">
                <Button
                  onClick={handleReset}
                  variant="outline"
                  className="text-[#fcba28] border-[#fcba28]/50 hover:bg-[#fcba28]/10 hover:border-[#fcba28] transition-all rounded-xl"
                >
