...
export const companyMilestones: Milestone[] = [
  {
    ...
    description: "The concept for InterviewMaster was born, aiming to simplify and modernize interview preparation for everyone.",
  },
  {
    year: 2025,
...
export const teamMembers: TeamMember[] = [
  {
    ...
    role: "Founder & CEO",
    description: "Visionary leader driving the mission of InterviewMaster.AI.",
  },
  {
    name: "Aisha Agrawal",
    role: "Co-Founder & COO",
...
export const companyDescription = {
  ...
  about: "InterviewMaster is a modern interview preparation platform combining expert-curated content, interactive practice, and a vibrant community. We offer mock interviews, real-time feedback, and comprehensive resources to help you succeed in your career journey.",
  features: [
